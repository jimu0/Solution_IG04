...
internal class Snapshot(in Unit[] units) : ISim
{
    private readonly Unit[] units = units;
    //private readonly Player player = player;
    //private readonly Totem[] totems = totems;
    ...
    public void OnSimStep(in Input input, ref WorldState state)
    {
        ...
        // state.playerState = state.totemsState[0];
        // state.playerState.position = player.position;
        // state.playerState.orientation = player.orientation;
